...
#The code supplements the paper Behrens, T., Junike, W. and Schoutens (2024).
...
#The implementation of the Lewis formula is based Theorem 3.2, Section 4 and Example 5.2 in Eberlein, Glau, and Papapantoleon (2010). The integral for the Lewis Formula are numerically solved by Gauss-Laguerre quadrature.
...
# Gauss–Laguerre coefficients: Number of terms to apply Gauss-Laguerre quadrature is here 200.
